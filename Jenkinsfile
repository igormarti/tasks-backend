pipeline {
    ...
    post {
        ...
        unsuccessfull {
            emailext attachLog: true, body: 'See the attached log below', subject: 'build $BUILD_NUMBER has failed', to: 'igorm573+jenkins@gmail.com'
        }

        fixed {
            emailext attachLog: true, body: 'See the attached log below', subject: 'build is fine!', to: 'igorm573+jenkins@gmail.com'
        }
    }
}